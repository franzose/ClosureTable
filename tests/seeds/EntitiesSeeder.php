...
class EntitiesSeeder extends \Seeder {
    ...
    public function run()
    {
        ...
        DB::insert($entitiesSql, [12, 'The title', 'The excerpt', 'The body', 0]);
        ...
        DB::insert($entitiesSql, [14, 'The title', 'The excerpt', 'The body', 2]);
        DB::insert($closuresSql, [14, 14, 0]);
        DB::insert($closuresSql, [9, 14, 1]);

        DB::insert($entitiesSql, [15, 'The title', 'The excerpt', 'The body', 3]);
